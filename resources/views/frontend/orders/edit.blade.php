                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.orders.update", [$order->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="order" id="order" value="{{ old('order', $order->order) }}" required>
                            @if($errors->has('order'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_cost" id="total_cost" value="{{ old('total_cost', $order->total_cost) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tax" id="tax" value="{{ old('tax', $order->tax) }}" step="0.01">
                            @if($errors->has('tax'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tax') }}
                                </div>
